...
const SECTORS: SectorConfig[] = [
  {
    ...
    code: "AGS-001",
    accent: "#0CF1FF",
    accentSoft: "rgba(12,241,255,0.22)",
    difficulty: "EASY",
    enemySpawnMs: 1450,
    enemyMax: 12,
    enemySpeed: 0.58,
  },
  {
    ...
    code: "AGS-002",
    accent: "#DB3FFD",
    accentSoft: "rgba(219,63,253,0.22)",
    difficulty: "MODERATE",
    enemySpawnMs: 1120,
    enemyMax: 15,
    enemySpeed: 0.68,
  },
  {
    ...
    code: "AGS-003",
    accent: "#FFC825",
    accentSoft: "rgba(255,200,37,0.22)",
    difficulty: "HARD",
    enemySpawnMs: 860,
    enemyMax: 18,
    enemySpeed: 0.78,
  ...
  return (
    <>
      <style jsx>{`
        ...
        .arcade-skin {
          font-family: var(--font-press-start), ui-monospace, monospace;
          image-rendering: pixelated;
          image-rendering: crisp-edges;
          background: #05010d;
        }
        .arcade-skin :global(img),
        .arcade-skin :global(canvas),
        .arcade-skin :global(video) {
          image-rendering: pixelated;
          image-rendering: crisp-edges;
        }
        .arcade-skin :global(*) {
      ...
      <main
      className="arcade-skin min-h-screen bg-[#05010d] px-3 py-6 text-white sm:px-6"
      style={
        {
    ...
    >
      ...
      >
        ...
        <header className="mb-4 flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-4">
          ...
          <div className="font-sans text-[9px] uppercase tracking-[0.2em] text-white/35">
            {sector.code} {"//"} SECTOR {String(sectorIndex + 1).padStart(2, "0")}
          </div>
        </header>

        <section
          className={`relative border-4 bg-[#05010d] ${
        ...
        >
          <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
            {visualParticles.map((particle, index) => (
              <span
                key={index}
                className="absolute h-[2px] w-[2px] opacity-40"
                style={{
                  left: particle.left,
                  top: particle.top,
          ...
          {screen === "playing" && (
            <>
              <div className="relative z-20 flex flex-wrap items-center justify-between gap-2 border-b-2 border-[#0CF1FF]/40 bg-[#05010d] px-3 py-2">
                <div className="flex flex-wrap gap-3 font-sans text-[18px] uppercase tracking-widest">
                ...
                <span className="font-sans text-[18px] uppercase tracking-widest text-white/35">
                  {formatTime(time)}
                </span>
              </div>
              ...
              >
                ...
                >
                  <div className="absolute inset-x-0 bottom-0 h-[110px] border-t-2 border-[#0CF1FF]/20 bg-[#05010d]" />

                  <div
                    className="absolute left-[70px] top-[52px] font-sans text-[8px] uppercase tracking-[0.3em]"
                    ...
                    (capsule) =>
                      !capsule.collected && (
                        ...
                        >
                          ...
                          />
                          <div
                            className="absolute -top-6 left-1/2 -translate-x-1/2 whitespace-nowrap font-sans text-[6px] uppercase tracking-[0.18em]"
                    ...
                    (pickup) =>
                      !pickup.collected && (
                        ...
                        >
                          ...
                          />
                          <div
                            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-sans text-[15px] font-bold"
                            style={{
                              color: sector.accent,
                              textShadow: "none",
                            }}
                          ...
                          <div
                            className="absolute -top-5 left-1/2 -translate-x-1/2 whitespace-nowrap font-sans text-[6px] uppercase tracking-[0.16em]"
                  ...
                  {boss.active && (
                    ...
                    >
                      ...
                      <div className="absolute -top-8 left-1/2 w-44 -translate-x-1/2 text-center font-sans text-[8px] uppercase tracking-[0.28em]">
                        <span style={{ color: sector.accent }}>
                          {sector.spirit} {"//"} BOSS
                        </span>
                      </div>
                ...
                <div
                  className={`pointer-events-none absolute top-3 right-3 rounded border bg-black/70 px-3 py-2 font-sans text-[11px] uppercase tracking-[0.18em] ${
  boss.revealed ? "motion-safe:animate-pulse" : ""
                ...
                <div className="pointer-events-auto absolute bottom-4 left-4 z-30 sm:hidden">
                  <div
                    ...
                    className="relative h-[88px] w-[88px] touch-none border-2 bg-[#05010d] opacity-90"
                    style={{
                ...
                <div className="pointer-events-none absolute bottom-4 right-4 z-30 sm:hidden">
                  <button
                    ...
                    className="pointer-events-auto flex h-16 w-16 touch-none items-center justify-center border-2 bg-[#05010d] font-sans text-[9px] uppercase tracking-[0.18em] opacity-90"
                    style={{
                      borderColor: `${sector.accent}`,
                      color: `${sector.accent}`,
                    }}
              ...
              <div className="border-t border-white/10 bg-black/80 px-3 py-2">
                <div className="flex items-center justify-between font-sans text-[8px] uppercase tracking-[0.22em] text-white/35">
          ...
          {screen !== "playing" && (
            ...
            >
              <div className="w-full max-w-2xl">
                ...
                <p
                  className="mt-12 font-sans text-[10px] uppercase tracking-[0.28em]"
                ...
                <div
                  className="mx-auto mt-4 inline-flex items-center gap-2 rounded border px-3 py-2 font-sans text-[9px] uppercase tracking-[0.22em]"
                  style={{
                    borderColor: `${sector.accent}35`,
                    color: sector.accent,
                ...
                <p className="mx-auto mt-5 max-w-xl font-sans text-xs uppercase leading-7 tracking-[0.14em] text-white/45">
                  {screen === "start" &&
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-3">
                  {screen === "start" && (
                    <button
                      type="button"
                      onClick={startGame}
                      className="rounded border px-6 py-3 font-sans text-[10px] uppercase tracking-[0.24em] transition hover:bg-white/5"
                      style={{
                        borderColor: sector.accent,
                        color: sector.accent,
                      }}
                ...
                {(screen === "complete" || screen === "gameover") && (
                  <div className="mx-auto mt-10 w-full max-w-lg">
                    {screen === "complete" && sectorIndex === SECTORS.length - 1 && (
                      <div
                        className="mb-4 rounded border px-4 py-3 text-center font-sans text-[9px] uppercase tracking-[0.24em]"
                        style={{
                          borderColor: `${sector.accent}35`,
                          background: `${sector.accent}08`,
                    ...
                    <div className="grid grid-cols-2 gap-2 font-sans text-[18px] uppercase tracking-widest sm:grid-cols-4">
                    ...
                    {screen === "complete" && sectorIndex === SECTORS.length - 1 && (
                      <p className="mt-4 text-center font-sans text-[9px] uppercase leading-6 tracking-[0.16em] text-white/35">
        ...
        <footer className="mt-4 flex flex-wrap items-center justify-between gap-2 font-sans text-[8px] uppercase tracking-[0.22em] text-white/25">
